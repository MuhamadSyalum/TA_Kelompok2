...
<section class="table">
    ...
    <thead>
        <tr>
            <th colspan="6"><h1>data pembeli MulaysStore</h1></th>
        </tr>
        <tr>
            <th width="60px">No</th>
            <th><h1>Nama</h1></th>
 ...
 $no = 1;
        ...
        while($pembeli = mysqli_fetch_array($query)){
            ...
            echo "<td><h1>".$pembeli['email']."</h1></td>";
            echo "<td><h1>".$pembeli['alamat']."</h1></td>";
            echo "<td><h1>".$pembeli['jenis_kelamin']."</h1></td>";
           
            
                
            echo "<td>";
            echo "<a href='editpembeli.php?id=".$pembeli['id']."'><h1>Edit</h1></a> | ";
            echo "<a href='hapus.php?id=".$pembeli['id']."'><h1>Hapus</h1></a>";
            echo "</td>";
    ...
    <tfoot>
        <tr>
            <th colspan="6"><a href="tambah.php"><h1>tambah peserta</h1></a></th>
        </tr>
        <tr>
            <th colspan="6"><h1>Total: <?php echo mysqli_num_rows($query) ?></h1></th>
        </tr>
    </tfoot>
    </table> 
</section>
