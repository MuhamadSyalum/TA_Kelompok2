...
<head>
  ...
  <title>Mulays Store</title>

  <!--
    - favicon
  -->
  <link rel="shortcut icon" href="./images/logo/favicon2.ico" type="image/x-icon">
    ...
    <div class="modal-content">
      ...
      <div class="newsletter">
          ...
          <div class="newsletter-header">
            ...
            <h3 class="newsletter-title">Pesan Melalui WhatsApp</h3>

            <p class="newsletter-desc">
            Pesan Sekarang!!!<b>Member</b> Mendapatkan diskon 5% dan gratis pengiriman
            </p>

          </div>

          <a href="https://wa.me/6283819181429?text=Bismillah%20Admin%20Saya%20member%20Ingin%20Memesan" class="fab fa-whatsapp"><button type="submit" class="btn-newsletter">Check Out Now!!</button></a>
  ...
  <header>
    ...
    <div class="header-top">
      ...
      <div class="container">
        ...
        <ul class="header-social-container">
          ...
          <li>
            <a href="https://m.facebook.com/muhammad.syalum" class="social-link">
              <ion-icon name="logo-facebook"></ion-icon>
            </a>
          </li>

          <li>
            <a href="https://mobile.twitter.com/MuhamadSyalum" class="social-link">
              <ion-icon name="logo-twitter"></ion-icon>
            </a>
          </li>

          <li>
            <a href="https://instagram.com/msyalum" class="social-link">
              <ion-icon name="logo-instagram"></ion-icon>
            </a>
          </li>

          <li>
            <a href="https://wa.me/6283819181429" class="social-link">
        ...
        <p>
           Untuk pembelian member diskon 5%
          </p>
    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <a href="./img/logo.svg" class="header-logo">
          <img src="img/logo.svg" alt="Mulays's logo" width="120" height="36">
        </a>
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  <img src="./images/products/party-wear-1.jpg" alt="Womens Party Wear Shoes" class="product-img default"
                    width="300">
                  <img src="./images/products/party-wear-2.jpg" alt="Womens Party Wear Shoes" class="product-img hover"
                    width="300">
